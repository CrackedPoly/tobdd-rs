...
use common::{AtomicOpCounts, DefaultManager, build_n_queens, default_node_num};
...
fn main() {
    ...
    println!(
        "n={} vars={} init_node_num={} init_cache_size={} iters={}",
        args.n, vars, args.node_num, args.cache_size, args.iters
    );
    ...
    for iter in 0..args.iters {
        ...
        let result = build_n_queens(&manager, args.n, &counter);
...
fn print_help() {
    println!(
        "N-Queens BDD example (single-thread)\n\n\
Usage:\n  cargo run --example n_queens -- [options]\n\n\
